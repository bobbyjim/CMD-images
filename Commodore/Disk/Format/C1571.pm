package Commodore::Disk::Format::C1571;
...
Commodore::Disk::Format::C1571 - D71/D72 format file for the Commodore disk image reader.
...
#  NOTES ON THE 1571
#
#  Free Sector Count for tracks 36-70:
#  The FSC for t36-70 are on header locations $DD-$FF.
#  This is annoying but a reality.  This bizarre setup is
#  why the 1571 has its own BAM Location value (0x47).
#
###############################################################
...
This file contains parametric data needed for correctly reading to and writing from a D71 or D72 file.
...
=cut
   ...
   sub zones
   {
      (
         ...
         { 'highTrack' => 52, 'sectorsPerTrack' => 21 },  
         { 'highTrack' => 59, 'sectorsPerTrack' => 19 },
         { 'highTrack' => 65, 'sectorsPerTrack' => 18 },  
         { 'highTrack' => 70, 'sectorsPerTrack' => 17 },
      );
   };

   sub BAMinterleave   { 0 }                              # 1 byte
   sub BAMlocation     { $BAM_SPILLS_OVER }               # 1 byte
   sub BootTrack       { 0x00 }                           # 1 byte

   sub BAMsectors         { 1  }                          # 1 byte
   sub tracksPerBAMsector { 35 }                          # 1 byte
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Commodore::Disk::Format::C1571
...
1; # End of Commodore::Disk::Format::C1571
