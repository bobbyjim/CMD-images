package Commodore::Disk::Format::C8050;
...
Commodore::Disk::Format::C8050 - D80 format file for the Commodore disk image reader.
...
=cut
   ...
   sub zones
   {
      (
         ...
         { 'highTrack' => 77, 'sectorsPerTrack' => 23 },  # 8 bytes
      );
   };
...
#  Derived Values
#
#  Methods which provide derived/calculated offsets.
#
######################################################
sub BAMsectors        { 2 }  # ?? Math.ceil( (TRACKS * BAM_BYTES_PER_TRACK)/(254-BAMlabelOffset) );
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Commodore::Disk::Format::C8050
...
1; # End of Commodore::Disk::Format::C8050
