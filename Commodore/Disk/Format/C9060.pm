package Commodore::Disk::Format::C9060;
...
Commodore::Disk::Format::C9060 - D96 format file for the Commodore disk image reader.
...
This file contains parametric data needed for correctly reading to and writing from a D96 file.

D96 - Commodore emulator file of a CBM-9060 diskette 

The 9060 was an IEEE-488 hard drive with 5MB storage and Commodore DOS 3.0.
...
=cut
   ...
   sub zones
   {
      (
         ...
         { 'highTrack' => 612, 'sectorsPerTrack' => 32 },  # 8 bytes (really!)
      );
   };
   ...
   sub BAMsectors        { 13 } # ?? Math.ceil( (TRACKS * BAM_BYTES_PER_TRACK)/(254-BAMlabelOffset) );
