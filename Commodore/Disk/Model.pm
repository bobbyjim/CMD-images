...
sub summary
{
   ...
   my $format  = "%4s %3s %2s %4d %4d %5d %3d %4d %2d %2d %2d %4d %4d %4d %4d %3d\n";
   my $format2 = "%4s %3s %2s %4s %4s %5s %3s %4s %2s %2s %2s %4s %4s %4s %4s %3s\n";
...
sub getSectorOffset
{
   ...
   #
   # KLUDGE: Translate forward if this is a 90x0
   #
   $track++ if $model->BAMlocation == 0x5a;
